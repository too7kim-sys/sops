...
INSERT INTO OPS_APPR_TEMPLATE (BIZ_TYPE, KIND, LINE_TYPE, STEP_NO, SORT_NO, TARGET_TYPE, TARGET_VALUE, MEMO) VALUES
 ...
 ('CHANGE', 'HANDLE','HANDLE',  3, 1, 'REQUESTER', NULL,    NULL),
...
-- 공통코드 그룹명
INSERT INTO OPS_CODE_GRP (GRP_CD, GRP_NM, SORT_ORDR, USE_AT) VALUES
('APPR_STATUS','결재 상태',10,'Y'),
 ('CAB_DECISION','CAB 심의결과',20,'Y'),
 ('CHANGE_STATUS','변경 상태',30,'Y'),
 ('CHANGE_TYPE','변경 유형',40,'Y'),
 ('CHECK_RESULT','점검 결과',50,'Y'),
 ('CHECK_TYPE','점검 유형',60,'Y'),
 ('CI_CHG_TYPE','형상 변경유형',70,'Y'),
 ('CI_STATUS','형상 상태',80,'Y'),
 ('CI_TYPE','형상 유형',90,'Y'),
 ('CSR_STATUS','요청 상태',100,'Y'),
 ('CSR_SUBTYPE','요청 소분류',110,'Y'),
 ('CSR_TYPE','요청 대분류',120,'Y'),
 ('ESCAL_LEVEL','에스컬레이션 단계',130,'Y'),
 ('EVENT_SEVERITY','이벤트 심각도',140,'Y'),
 ('EVENT_STATUS','이벤트 상태',150,'Y'),
 ('EVENT_TYPE','이벤트 유형',160,'Y'),
 ('INCIDENT_SEVERITY','장애 심각도',170,'Y'),
 ('INCIDENT_STATUS','장애 상태',180,'Y'),
 ('INTF_STATUS','연계 상태',190,'Y'),
 ('INTF_TYPE','연계 유형',200,'Y'),
 ('LINE_TYPE','결재라인 유형',210,'Y'),
 ('PRIORITY','우선순위',220,'Y'),
 ('PROBLEM_STATUS','문제 상태',230,'Y'),
 ('RELEASE_ITEM_RESULT','배포항목 결과',240,'Y'),
 ('RELEASE_STATUS','배포 상태',250,'Y'),
 ('TARGET_TYPE','대상 유형',260,'Y'),
 ('TEST_CASE_RESULT','테스트케이스 결과',270,'Y'),
 ('TEST_ENV','테스트 환경',280,'Y'),
 ('TEST_STATUS','테스트 상태',290,'Y'),
 ('TEST_TYPE','테스트 유형',300,'Y');

-- 변경 처리유형
INSERT INTO OPS_CODE (CODE_GRP, CODE_ID, CODE_NM, SORT_ORDR, USE_AT) VALUES
 ('CHANGE_PROC_TYPE', 'NORMAL',    '일반변경', 1, 'Y'),
 ('CHANGE_PROC_TYPE', 'STANDARD',  '단순변경', 2, 'Y'),
 ('CHANGE_PROC_TYPE', 'EMERGENCY', '긴급변경', 3, 'Y');
INSERT INTO OPS_CODE_GRP (GRP_CD, GRP_NM, SORT_ORDR, USE_AT) VALUES ('CHANGE_PROC_TYPE', '변경 처리유형', 35, 'Y');
