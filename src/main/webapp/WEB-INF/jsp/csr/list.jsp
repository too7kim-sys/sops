...
<div class="panel mb0">
    ...
    <div class="list-scroll"><table class="list">
        ...
        <tr>
            ...
            <th class="center" style="width:110px;">완료요구일</th>
        ...
        <c:forEach var="c" items="${csrList}">
            <tr>
                ...
                <td class="center">${empty c.dueDt ? '-' : c.dueDt}</td>
                ...
                <td class="center">${uf:nm(userNameMap, c.reqId)}</td>
            </tr>
        </c:forEach>
        <c:if test="${empty csrList}"><tr><td colspan="8" class="empty">등록된 요청이 없습니다.</td></tr></c:if>
        </tbody>
    </table></div>
